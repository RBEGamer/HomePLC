...
node_blor::node_blor(int id, bool us, const int con_count, std::string params,bool is_static, bool ut)
{
...
void node_blor::update(float timestep)
{
...
void node_blor::set_connection(int pos, base_node * ptr, int dest_pos)
{
	if (ptr != NULL) {
...
float node_blor::get_value_f(int position)
{
	switch (position)
	{
...
int node_blor::get_value_i(int position)
{
	switch (position)
	{
...
bool node_blor::get_value_b(int position)
{
	switch (position)
	{
...
std::string node_blor::get_value_s(int position)
{
	switch (position)
	{
