...
class node_bndmx : public base_node
{
public:
	node_bndmx(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_bndmx();
	...
	//PARAMS
	std::string channel;	//param 2
	std::string mid;		//param 0
	std::string msi;		//param 1
							//CONECTION
	int p0_value_input_state; //pos 0
