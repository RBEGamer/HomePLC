...
class node_stringoffset : public base_node
{
public:
	node_stringoffset(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_stringoffset();
