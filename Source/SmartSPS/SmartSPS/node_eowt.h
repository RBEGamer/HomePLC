...
class node_eowt : public base_node
{
public:
	node_eowt(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_eowt();
	...
	//PARAMS
	std::string temp_sensor;	//param 2
	std::string mid;		//param 0
	std::string msi;		//param 1

							//VALUES
	float p0_value_output_state; //pos 0
