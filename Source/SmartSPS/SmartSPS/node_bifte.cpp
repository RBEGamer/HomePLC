#include "node_bifte.h"

node_bifte::node_bifte(int id, bool us, const int con_count, std::string params, bool is_static, bool ut)
{
...
node_bifte::~node_bifte()
{
	delete(p_connections);
}

void node_bifte::update(float timestep)
{
...
void node_bifte::init()
{
	node_bifte::p0_toggle_input = false;
...
void node_bifte::set_connection(int pos, base_node * ptr, int dest_pos)
{
...
void node_bifte::set_value(int position, bool value)
{
	bool uv = true;
	switch (position)
	{
...
float node_bifte::get_value_f(int position)
{
	
}

int node_bifte::get_value_i(int position)
{

}

bool node_bifte::get_value_b(int position)
{
	
}

std::string node_bifte::get_value_s(int position)
{
