...
class node_bnidisp : public base_node
{
public:
	node_bnidisp(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_bnidisp();
	...
	//PARAMS
	std::string line;	//param 2
	std::string mid;		//param 0
	std::string msi;		//param 1
							//CONECTION
	std::string p0_value_input_state; //pos 0
