...
class node_basiccounter : public base_node
{
public:
	node_basiccounter(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_basiccounter();
	...
	//VALUES
	bool p0_toggle_input;
	float p1_incvalue_input;
	bool p2_setzero_input;
	float p3_counterout_output;
	float counter_last_state;
