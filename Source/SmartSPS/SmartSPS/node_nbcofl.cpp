#include "node_nbcofl.h"

node_nbcofl::node_nbcofl(int id, bool us, const int con_count, std::string params, bool is_static, bool ut)
{
...
node_nbcofl::~node_nbcofl()
{
	delete(p_connections);
}

void node_nbcofl::update(float timestep)
{
...
void node_nbcofl::init()
{
	update();
}

void node_nbcofl::load_node_parameters(std::string params)
{
		...
		if (start_param != 0) {
			...
			if (end_param != 0) {
				...
				if (param_result != "") {
					...
					{
					case 0: const_int_value = atof(param_result.c_str()); break;
					default:
						break;
					}
					param_counter++;
...
void node_nbcofl::set_connection(int pos, base_node * ptr, int dest_pos)
{
	if (ptr != NULL) {
...
void node_nbcofl::serial_income(std::string message)
{
	update();
}

void node_nbcofl::set_value(int position, float value)
{
	update();
}

void node_nbcofl::set_value(int position, int value)
{
	update();
}

void node_nbcofl::set_value(int position, bool value)
{
	update();
}

void node_nbcofl::set_value(int position, std::string value)
{
	update();
}
...
float node_nbcofl::get_value_f(int position)
{

}

int node_nbcofl::get_value_i(int position)
{

}

bool node_nbcofl::get_value_b(int position)
{

}

std::string node_nbcofl::get_value_s(int position)
{
