#include "node_nbsttof.h"

node_nbsttof::node_nbsttof(int id, bool us, const int con_count, std::string params, bool is_static, bool ut)
{
...
node_nbsttof::~node_nbsttof()
{
	delete(p_connections);
}

void node_nbsttof::update(float timestep)
{
	...
	if (updated_values) {
		...
		p1_b_output = atof(p0_a_input.c_str());
...
void node_nbsttof::set_connection(int pos, base_node * ptr, int dest_pos)
{
	if (ptr != NULL) {
...
float node_nbsttof::get_value_f(int position)
{

}

int node_nbsttof::get_value_i(int position)
{

}

bool node_nbsttof::get_value_b(int position)
{

}

std::string node_nbsttof::get_value_s(int position)
{
