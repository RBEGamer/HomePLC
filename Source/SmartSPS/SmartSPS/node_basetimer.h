...
class node_basetimer : public base_node
{
public:
	node_basetimer(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_basetimer();
