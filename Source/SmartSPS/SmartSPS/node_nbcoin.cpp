#include "node_nbcoin.h"

node_nbcoin::node_nbcoin(int id, bool us, const int con_count, std::string params, bool is_static, bool ut)
{
...
node_nbcoin::~node_nbcoin()
{
	delete(p_connections);
}

void node_nbcoin::update(float timestep)
{
		...
		if (start_param != 0) {
			...
			if (end_param != 0) {
				...
				if (param_result != "") {
					...
					{
					case 0: const_int_value = atoi(param_result.c_str()); break;
					default:
						break;
					}
					param_counter++;
...
void node_nbcoin::set_connection(int pos, base_node * ptr, int dest_pos)
{
	if (ptr != NULL) {
...
float node_nbcoin::get_value_f(int position)
{

}

int node_nbcoin::get_value_i(int position)
{

}

bool node_nbcoin::get_value_b(int position)
{

}

std::string node_nbcoin::get_value_s(int position)
{
