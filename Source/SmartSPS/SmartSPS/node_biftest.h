...
class node_biftest : public base_node
{
public:
	node_biftest(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_biftest();
	...
	std::string p1_iftrue_input;
	std::string p2_ifelse_input;
	std::string p3_value_output;
