...
class node_nbfltostr : public base_node
{
public:
	node_nbfltostr(int id, bool us, const int con_count, std::string params, bool is_static, bool ut);
	~node_nbfltostr();
	...
	//VALUES
	float p0_a_input; //pos 0
	std::string p1_b_output;
